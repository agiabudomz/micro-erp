...
// Lógica de Exclusão (Segura com Prepared Statement)
...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4 sm:p-6 text-slate-800">
    ...
    <div class="w-full max-w-xl">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/60 p-8 sm:p-10 border border-slate-100">
            ...
            <form method="POST" class="space-y-6">
                ...
                <div class="input-group">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="<?= htmlspecialchars($p['name']) ?>" required
                            class="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all placeholder-slate-400"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="input-group">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Preço de Custo (R$)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 icon-box transition-all">
                            ...
                            <input type="number" step="0.01" name="buy_price" value="<?= $p['buy_price'] ?>" required
                                class="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all"
                                placeholder="0,00">
                        </div>
                    </div>
                    
                    <div class="input-group">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Preço de Venda (R$)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 icon-box transition-all">
                ...
                <div class="pt-6 space-y-3">
                    <button type="submit" 
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-bold shadow-lg shadow-blue-200 flex items-center justify-center gap-2 transform active:scale-[0.98] transition-all">
